...
function getElementsClass(a){for(var b=[],c=0,f=document.getElementsByTagName("*"),d=0;d<f.length;d++)1===f[d].nodeType&&f[d].getAttribute("class")===a&&(b[c]=f[d],c++);return b}var SimpleUtils=function(){};SimpleUtils.getVersion=function(){return"1.2.1"};
...
$("body").addClass("options-plugin-theme")};Simple.prototype.finally=function(){$('.user-nav li[class="return"]').remove()};Simple.prototype.comments_page_init=function(){Comments_page.filter_comments()};Simple.prototype.managetags_page_init=function(){Managetags_page.tags_init()};Simple.prototype.admin_index_page_init=function(){Admin_index_page.init()};
...
Simple.prototype.input_init=function(){$("input[type=checkbox]").each(function(a,b){0<$(b).parents(".csf-fieldset").length||$(b).hasClass("form-check-input")||($(b).addClass("form-check-input"),$(b).parent().addClass("form-check"),$(b).next("label").addClass("form-check-label"))});$("input[type=radio]").each(function(a,b){0<$(b).parents(".csf-fieldset").length||$(b).hasClass("form-check-input")||($(b).addClass("form-check-input"),$(b).parent("span").addClass("form-check"),$(b).next("label").addClass("form-check-label"))});
$("input[type=text]").each(function(a,b){0<$(b).parents(".csf-fieldset").length||$(b).hasClass("form-control")||$(b).addClass("form-control")})};Simple.prototype.button_init=function(){$("button.btn").each(function(a,b){0<$(b).parents(".csf-fieldset").length||($(b).hasClass("primary")?($(b).removeClass("primary"),$(b).addClass("btn-primary btn-jelly")):$(b).hasClass("btn-warn")&&($(b).removeClass("btn-warn"),$(b).addClass("btn-warning btn-jelly")))})};
Simple.prototype.select_init=function(){$("select").each(function(a,b){0<$(b).parents(".csf-fieldset").length||(a=$(b).prop("outerHTML"),$(b).prop("outerHTML",'<li class="select sd-select">'+a+"</li>"),$("#visibility").change(function(){var c=$(this).val(),f=$("#post-password");"password"===c?f.removeClass("hidden"):f.addClass("hidden")}))})};Simple.prototype.table_init=function(){$("table.typecho-list-table").addClass("table")};
