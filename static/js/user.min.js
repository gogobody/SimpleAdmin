...
function getElementsClass(a){for(var b=[],c=0,f=document.getElementsByTagName("*"),d=0;d<f.length;d++)1===f[d].nodeType&&f[d].getAttribute("class")===a&&(b[c]=f[d],c++);return b}var SimpleUtils=function(){};SimpleUtils.getVersion=function(){return"1.2.0"};
